...
#ifndef CIRCE_LOGGER_NAME
#    define CIRCE_LOGGER_NAME "Circe"
#endif

#ifndef CIRCE_LOG_LEVEL
#    if defined(CIRCE_VERBOSE)
#        define CIRCE_LOG_LEVEL LogLevel::Trace
#    elif defined(CIRCE_DEBUG)
#        define CIRCE_LOG_LEVEL LogLevel::Debug
#    elif defined(CIRCE_RELEASE)
#        define CIRCE_LOG_LEVEL LogLevel::Info
#    else
#        define CIRCE_LOG_LEVEL LogLevel::Off
#    endif
#endif
...
class Internal_Log_ {
    ...
    static void init() {
        if (!was_initialized) {
            ...
            logger->set_level(static_cast<spdlog::level::level_enum>(CIRCE_LOG_LEVEL));
    ...
    inline static std::string logger_name {CIRCE_LOGGER_NAME};
